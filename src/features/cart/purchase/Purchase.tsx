...
export const Purchase = React.memo((props: PurchasePropsType) => {
    return (
        <Grid container direction="row" justify="center" alignItems="center" alignContent={'center'} style={{padding:'10px'}}>
            <Grid container item xs={12} md={4} alignContent="center" justify={'center'}>
                <img
            ...
            <Grid container item xs={12} md={4} direction={'column'} justify={'space-evenly'}>
                <p>Title : {props.book.title}</p>
                <p>Author: {props.book.author}</p>
                <p>Price: {props.book.price} $</p>
            </Grid>
            <Grid container item xs={12} md={4} justify={'space-evenly'} alignItems={'center'} direction={'row'}  >
